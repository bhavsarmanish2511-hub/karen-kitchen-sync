...
// --------- MODIFIED ALERTS DATA ORDER BELOW ---------
const alertsData = [
  {
    id: "6",
    ...
    coordinates: [-97, 32] as [number, number], // Texas
  },
  {
    id: "1",
    ...
    coordinates: [10, 53] as [number, number], // Hamburg
  },
  {
    id: "2",
    ...
    coordinates: [72, 19] as [number, number], // Mumbai
  },
  {
    id: "3",
    ...
    coordinates: [72.9, 20.2] as [number, number], // Silvassa
  },
  {
    id: "4",
    ...
    coordinates: [9.19, 45.46] as [number, number], // Milan
  },
  {
    id: "5",
    ...
    coordinates: [80.27, 13.08] as [number, number], // Chennai
  },
];
...
export function SupplyChainMap() {
  ...
  const handleAlertClick = (alertId: string) => {
    ...
    if (alert) {
      // Set zoom location to trigger map animation
      setZoomLocation({
      ...
      setTimeout(() => {
        ...
        setZoomLocation(null); // Reset zoom location
      }, 3500);
    }
  };
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Map Card */}
        <Card className="p-6 bg-gradient-card border-border flex-1 h-[600px] flex flex-col">
          ...
          {/* Ensure map fills the card */}
          <div className="flex-1 min-h-0">
            <SupplyChainMapMain zoomToLocation={zoomLocation} />
          </div>
        </Card>
        ...
        <Card className="p-6 bg-gradient-card border-border flex-1 h-[600px] flex flex-col">
          ...
          {/* Scrollable alerts list, fills remaining space */}
